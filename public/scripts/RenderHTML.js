...
/***/ "./src/Includes/js/ParseHelper.js":
/*!****************************************!*\
  !*** ./src/Includes/js/ParseHelper.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   cleanArrayObject: () => (/* binding */ cleanArrayObject),
/* harmony export */   definedTypes: () => (/* binding */ definedTypes),
/* harmony export */   getSelectValue: () => (/* binding */ getSelectValue),
...
/* harmony import */ var _form_XaiForm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./form/XaiForm */ "./src/Includes/js/form/XaiForm.js");
...
/* harmony import */ var _form_fields__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./form/fields */ "./src/Includes/js/form/fields/index.js");





var cleanArrayObject = function cleanArrayObject(array) {
  var arrayObject = array.map(function (component) {
    if (component.type === "text") {
      return component.data.trim();
    }
    return component;
  });
  return arrayObject.filter(function (value) {
    return value !== "";
  });
};
var definedTypes = ["email", "cardnumber", "cvc", "expirydate", "price", "button", "submit", "next", "back"];
var getTagComponent = function getTagComponent(tag, type) {
  var components = {
    input: _form_fields__WEBPACK_IMPORTED_MODULE_4__.InputField,
    email: _form_fields__WEBPACK_IMPORTED_MODULE_4__.EmailAddress,
    cardnumber: _form_fields__WEBPACK_IMPORTED_MODULE_4__.CardNumber,
    cvc: _form_fields__WEBPACK_IMPORTED_MODULE_4__.CardCVC,
    expirydate: _form_fields__WEBPACK_IMPORTED_MODULE_4__.CardExpiryDate,
    price: _form_fields__WEBPACK_IMPORTED_MODULE_4__.PriceAmount,
    next: _form_fields__WEBPACK_IMPORTED_MODULE_4__.ButtonNext,
    back: _form_fields__WEBPACK_IMPORTED_MODULE_4__.ButtonBack,
    submit: _form_fields__WEBPACK_IMPORTED_MODULE_4__.Button,
    button: _form_fields__WEBPACK_IMPORTED_MODULE_4__.Button,
    select: _form_fields__WEBPACK_IMPORTED_MODULE_4__.Select,
    fieldvalue: _form_fields__WEBPACK_IMPORTED_MODULE_4__.FieldValue,
    form: _form_XaiForm__WEBPACK_IMPORTED_MODULE_1__["default"],
    tab: _components_Tab__WEBPACK_IMPORTED_MODULE_3__["default"],
    step: _components_Step__WEBPACK_IMPORTED_MODULE_2__["default"]
  };
  return type && definedTypes.includes(type) ? components[type] : components[tag];
};
var getSelectValue = function getSelectValue(options) {
  if (Array.isArray(options)) {
    for (var i = 0; i < options.length; i += 1) {
      var option = options[i];
      if (option.type === "tag" && option.name === "option") {
        var _attributesToProps = (0,html_react_parser__WEBPACK_IMPORTED_MODULE_0__.attributesToProps)(option.attribs),
          value = _attributesToProps.value,
          selected = _attributesToProps.selected;
        if (selected) {
          return value;
        }
      }
...
/***/ "./src/Includes/js/ParseOptions.js":
/*!*****************************************!*\
  !*** ./src/Includes/js/ParseOptions.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _ParseHelper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ParseHelper */ "./src/Includes/js/ParseHelper.js");
...
var getParseOptions = function getParseOptions() {
  ...
  var parseOptions = {
    replace: function replace(_ref) {
      ...
      var props = (0,html_react_parser__WEBPACK_IMPORTED_MODULE_1__.attributesToProps)(attribs);
      if (["input", "select", "textarea"].includes(name)) {
        if (props.name && props.type !== "submit") {
          fieldValues[props.name] = props.value ? props.value : "";
        }
        if (name === "select") {
          fieldValues[props.name] = (0,_ParseHelper__WEBPACK_IMPORTED_MODULE_2__.getSelectValue)(children);
        }
      }
      var Element = (0,_ParseHelper__WEBPACK_IMPORTED_MODULE_2__.getTagComponent)(name, props.type);
      if (!Element) {
        return null;
      }
      switch (Element.name) {
        ...
        case "ButtonBack":
          {
            var btnCopy = name === "input" ? props.value : children;
            return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(Element, _objectSpread(_objectSpread({}, props), {}, {
              children: btnCopy
            }));
          }
        case "Step":
          {
            ...
            indexStep += 1;
            var stepName = "step-".concat(indexStep);
            steps.push(stepName);
            return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(Element, {
              name: stepName,
              className: className,
              children: (0,html_react_parser__WEBPACK_IMPORTED_MODULE_1__.domToReact)(children, parseOptions)
            });
          }
        case "Tab":
          {
        ...
        default:
          return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(Element, _objectSpread({}, props));
      }
    }
  };
  return parseOptions;
...
/***/ "./src/Includes/js/components/Children.js":
/*!************************************************!*\
  !*** ./src/Includes/js/components/Children.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var renderChild = function renderChild(child) {
  ...
  if (_typeof(child) === "object" && child !== null) {
    ...
    var props = (0,html_react_parser__WEBPACK_IMPORTED_MODULE_1__.attributesToProps)(child.attribs);
    var children = child.children;
    var ElementChild = child.name;
    if (Array.isArray(children) && children.length > 0) {
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(ElementChild, _objectSpread(_objectSpread({}, props), {}, {
        children: children.map(function (subChild) {
          return renderChild(subChild);
        })
      }));
    }
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(ElementChild, _objectSpread({}, props));
  }
  return child;
};
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _components_Children__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../components/Children */ "./src/Includes/js/components/Children.js");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react/jsx-runtime */ "./node_modules/react/jsx-runtime.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var Button = function Button(props) {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(ButtonComponent, _objectSpread(_objectSpread({
    type: type,
    className: className
  }, rest), {}, {
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components_Children__WEBPACK_IMPORTED_MODULE_0__["default"], {
      children: children
    })
  }));
};
...
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! react/jsx-runtime */ "./node_modules/react/jsx-runtime.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
var _excluded = ["label", "name", "className", "type", "placeholder", "id", "required"];
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { _defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
function _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
...
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! react/jsx-runtime */ "./node_modules/react/jsx-runtime.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
var _excluded = ["label", "name", "className", "type", "placeholder", "id", "required", "options"];
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { _defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
function _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
...
var Options = function Options(props) {
  var data = props.data;
  return data.map(function (option, index) {
    if (option.type === "text") {
      return null;
    }
    var _attributesToProps = (0,html_react_parser__WEBPACK_IMPORTED_MODULE_2__.attributesToProps)(option.attribs),
      value = _attributesToProps.value;
    var uniqueKey = value ? "".concat(value, "-").concat(index) : "".concat(option.name, "-").concat(index);
    if (option.name === "optgroup") {
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("optgroup", {
        label: option.attribs.label,
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("option", {
      ...
      children: option.children[0].data
    }, uniqueKey);
  });
};
var Select = function Select(props) {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
    ...
    children: [label ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_Label__WEBPACK_IMPORTED_MODULE_3__["default"], {
      text: label,
      domId: id || null
    }) : "", /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(formik__WEBPACK_IMPORTED_MODULE_1__.Field, _objectSpread(_objectSpread({
      id: id || null,
      className: className || null,
      name: name,
      as: "select"
      ...
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(Options, {
        data: options,
        name: name
      })]
    })), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(formik__WEBPACK_IMPORTED_MODULE_1__.ErrorMessage, {
...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[3]!./src/Includes/sass/default.scss":
/*!******************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[3]!./src/Includes/sass/default.scss ***!
  \******************************************************************************************************************************************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "input {\n  font-size: 16px;\n  font-weight: 400;\n  max-width: 100%;\n}\n\n.error {\n  color: red;\n  line-height: 20px;\n  font-weight: 400;\n  display: inline-block;\n  margin-top: 5px;\n}\n\n.creditCardNumber {\n  display: flex;\n  align-items: center;\n  position: relative;\n}\n.creditCardNumber svg {\n  position: absolute;\n  width: 30px;\n  height: auto;\n  left: 10px;\n}\n.creditCardNumber input {\n  padding-left: 45px !important;\n}\n\nbutton.link {\n  background: none;\n  border-top: 0;\n  border-left: 0;\n  border-right: 0;\n}\nbutton.link:hover {\n  color: #bbb;\n  cursor: pointer;\n}\nbutton.link:focus {\n  outline: 0;\n}\n\n.btn-medium-size {\n  width: 155px;\n  text-align: left;\n}\n\n.cc-number-review {\n  display: flex;\n  align-items: center;\n}\n.cc-number-review svg {\n  margin-right: 5px;\n  height: auto;\n  width: 32px;\n}", ""]);
// Exports
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_2_node_modules_sass_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_3_default_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!../../../node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!../../../node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[3]!./default.scss */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[3]!./src/Includes/sass/default.scss");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_2_node_modules_sass_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_3_default_scss__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/******/ 	__webpack_require__.O(undefined, ["styles/admin"], () => (__webpack_require__("./src/Includes/js/RenderHTML.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["styles/admin"], () => (__webpack_require__("./src/Includes/sass/admin.scss")))
